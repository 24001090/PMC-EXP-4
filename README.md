...
lcd = Lcd_create(ports,pins,GPIOB,GPIO_PIN_0,GPIOB,GPIO_PIN_1,LCD_4_BIT_MODE);
  ...
  {
	    Lcd_cursor(&lcd,0,1);
	  	Lcd_string(&lcd,"POOJA PRIYA B\n");
	  	Lcd_cursor(&lcd,1,1);
	  	Lcd_string(&lcd,"212224230196\n");
}
}
void SystemClock_Config(void)
{
...
<img width="1412" height="956" alt="Screenshot 2026-05-13 094641" src="https://github.com/user-attachments/assets/0aaaa2e4-ebd1-49bf-a3fa-c426904f06f3" />
 <img width="1370" height="961" alt="Screenshot 2026-05-13 094817" src="https://github.com/user-attachments/assets/f5f3930b-cb1a-4d3a-a9d2-e8b1bc1f824f" />

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 

 <img width="1223" height="881" alt="image" src="https://github.com/user-attachments/assets/30f6f41b-6c63-42cd-bda7-141f87201c59" />
